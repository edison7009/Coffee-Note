...
AI4L is a **source for research methods**, not a factual source for Tier Note conclusions and not a web template to copy verbatim.
...
Tier Note does not directly adopt:
...
AI4L uses the MIT license. Tier Note’s localized method is a reorganized derivative checklist framework that preserves the upstream project name, link, version, and license record. See [AI4L-MIT.md](../licenses/AI4L-MIT.md) for the original MIT license.
...
3. Merge only changes compatible with Tier Note’s source policy into the local framework;
