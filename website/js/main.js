(() => {
  ...
  const copy = {
    zh: {
      metaTitle: "延寿，是人类在 AI 时代最有价值的投资。 — TierNote",
      metaDescription: "本地优先、由科学依据支持的延寿知识与 AI 桌面应用。独立资料库，中英双语，支持 Windows、macOS 与 Linux。",
      brand: "TierNote（开源延寿）", navPrinciples: "理念", navProduct: "产品", navEvidence: "证据", navModels: "AI 模型",
      heroLead: "延寿，是人类", heroSecondLine: "在 AI 时代最有价值的投资。",
      heroBody: "富豪花费百万美元借助科技延寿，而 TierNote 希望把生命之光同样带给普通家庭；以 Bryan Johnson 公开的延寿计划为蓝本，融入 AI 与科学依据，让普通人也能拥有富豪级的延寿策略。",
      install: "安装 TierNote", star: "在 GitHub 上点星", copy: "复制", copied: "已复制", copyCommand: "复制安装命令",
      macosNote: "macOS 首次需在「终端」",
      statementEyebrow: "TIERNOTE / 开放宣言", statement: "科学延寿，不应该是富豪专属。",
      statementBody: "昂贵的私人团队、封闭的数据和难以验证的建议，不该成为通往更长生命的门槛。TierNote 希望把知识、证据与工具打开，让每个人都能理解、检查并建立自己的延寿计划。",
      ...
      homeCaption: "首页 · 延寿策略地图", homeAlt: "TierNote 中文首页与策略地图",
      nadCaption: "NAD+ · 证据与资料在同一页", nadAlt: "TierNote 中文 NAD+ 知识页面",
      evidenceEyebrow: "优先级，不是假装精确的分数", evidenceTitle: "先做确定性更高的事。",
      evidenceBody: "TierNote 默认参考公开方案与证据成熟度给出起始排序，但保留适用条件与不确定性。你可以按自己的理解调整，也可以让 AI 协助重排。",
      ...
      modelCaption: "模型与知识库 · 配置保存在本地", modelAlt: "TierNote 模型与知识库配置界面",
      closing1: "AI 和科学，", closing2: "改变人类命运。", returnTop: "回到生命之树", footerNote: "科学延寿知识与 AI 桌面应用",
    },
    en: {
      metaTitle: "Longevity is humanity’s most valuable investment in the age of AI. — TierNote",
      ...
      brand: "TierNote", navPrinciples: "Principles", navProduct: "Product", navEvidence: "Evidence", navModels: "AI models",
      heroLead: "Longevity is humanity’s", heroSecondLine: "most valuable investment in the age of AI.",
      heroBody: "The wealthy spend millions on longevity technology, while TierNote aims to bring that same light of life to ordinary families; built on Bryan Johnson's publicly documented longevity plan and enriched with AI and scientific evidence, it makes longevity strategies once reserved for the wealthy accessible to ordinary people.",
      install: "Install TierNote", star: "Star on GitHub", copy: "Copy", copied: "Copied", copyCommand: "Copy the install command",
      macosNote: "On first launch, run in macOS Terminal:",
      statementEyebrow: "TIERNOTE / AN OPEN MANIFESTO", statement: "Longevity science should not belong only to the wealthy.",
      statementBody: "Expensive private teams, closed data, and advice that cannot be examined should not stand between people and a longer life. TierNote opens the knowledge, evidence, and tools so anyone can understand, inspect, and build a plan of their own.",
      ...
      homeCaption: "HOME · LONGEVITY STRATEGY MAP", homeAlt: "TierNote home and strategy map",
      nadCaption: "NAD+ · EVIDENCE AND SOURCES IN ONE VIEW", nadAlt: "TierNote NAD+ knowledge page",
      ...
      modelCaption: "MODEL & LIBRARY · CONFIGURATION STAYS LOCAL", modelAlt: "TierNote model and knowledge-library configuration",
